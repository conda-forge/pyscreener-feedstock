...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyscreener-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyscreener-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install pyscreener
```
...
It is possible to list all of the versions of `pyscreener` available on your platform:
...
```
pixi search pyscreener --channel conda-forge
```
